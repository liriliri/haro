...
export type IpcOpenHilog = (connectKey: string) => Promise<string>
export type IpcCloseHilog = (hilogId: string) => Promise<void>
export type IpcPauseHilog = IpcCloseHilog
export type IpcResumeHilog = IpcCloseHilog
