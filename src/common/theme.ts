// light
export const colorPrimary = `#589cf5`
...
export const colorBorder = `#d1d1d1`
...
export const colorPrimaryBg = `#f0f9ff`
export const colorPrimaryBgHover = `#f0f8ff`
export const colorPrimaryBorder = `#d6ecff`
export const colorPrimaryBorderHover = `#add6ff`
export const colorPrimaryHover = `#85beff`
export const colorPrimaryActive = `#4079cf`
export const colorPrimaryTextHover = `#85beff`
export const colorPrimaryText = `#589cf5`
export const colorPrimaryTextActive = `#4079cf`
...
export const controlItemBgActive = `#f0f9ff`
export const controlItemBgActiveHover = `#f0f8ff`
export const controlItemBgActiveDisabled = `rgba(0, 0, 0, 0.15)`
export const controlTmpOutline = `rgba(0, 0, 0, 0.02)`
export const controlOutline = `rgba(240, 249, 255, 0.97)`
...
// dark
export const colorPrimaryDark = `#4e88d3`
...
export const colorBgContainerDark = `#3c3f41`
export const colorBorderDark = `#464646`
...
export const colorPrimaryBgDark = `#181e2a`
export const colorPrimaryBgHoverDark = `#1f2d43`
export const colorPrimaryBorderDark = `#283d58`
export const colorPrimaryBorderHoverDark = `#335179`
export const colorPrimaryHoverDark = `#7aade8`
export const colorPrimaryActiveDark = `#406ca6`
export const colorPrimaryTextHoverDark = `#7aade8`
export const colorPrimaryTextDark = `#4e88d3`
export const colorPrimaryTextActiveDark = `#406ca6`
...
export const colorBorderBgDark = `#3c3f41`
export const colorSplitDark = `rgba(14, 5, 0, 0.26)`
...
export const colorErrorOutlineDark = `rgba(35, 0, 2, 0.65)`
export const colorWarningOutlineDark = `rgba(37, 22, 0, 0.74)`
